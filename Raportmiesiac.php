...
if(isset($_POST['Generate'])){
    $RaportMiesiac = $_POST['RaportMiesiac'];
    if ($RaportMiesiac=="Styczeń")$RaportMiesiac="01";
    if ($RaportMiesiac=="Luty")$RaportMiesiac="02";
    if ($RaportMiesiac=="Marzec")$RaportMiesiac="03";
    if ($RaportMiesiac=="Kwiecień")$RaportMiesiac="04";
    if ($RaportMiesiac=="Maj")$RaportMiesiac="05";
    if ($RaportMiesiac=="Czerwiec")$RaportMiesiac="06";
    if ($RaportMiesiac=="Lipiec")$RaportMiesiac="07";
    if ($RaportMiesiac=="Sierpień")$RaportMiesiac="08";
    if ($RaportMiesiac=="Wrzesień")$RaportMiesiac="09";
    if ($RaportMiesiac=="Październik")$RaportMiesiac="10";
    if ($RaportMiesiac=="Listopad")$RaportMiesiac="11";
    if ($RaportMiesiac=="Grudzień")$RaportMiesiac="12";
    if($RaportMiesiac) {
        header("location: RaportmiesiacGotowy.php?RaportMiesiac=$RaportMiesiac");
    }    
} 
?>
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Stwórz Raport Miesiąca" />
        <meta name="author" content="Zespół I" />
        <title>Stwórz Raport Miesiąca</title>
...
<!-- Przycisk rozwijany 
Stwórz Raport Miesiąca -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Stwórz Raport Miesiąca</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Stwórz Raport Miesiąca</h1>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <select class="form-control" id="inputMiesiac" name="RaportMiesiac" type="text">
                                                ...
                                                <label for="inputLastName">Dzień</label>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input class="btn btn-primary btn-block" name="Generate" type="submit" value="Generuj Raport"></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
