...
$getPracownik = $_GET['RaportPracownik'];
$sql = "SELECT * FROM Planner WHERE `Nazwisko i Imie` = '$getPracownik'";
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Raport Pracownika" />
        <meta name="author" content="Zespół I" />
        <title>Raport Pracownika</title>
...
<!-- Przycisk rozwijany 
Raport Pracownika -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Raport Pracownika</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Raport Pracownika</h1>
...
<!-- Miejsce na treść właściwą-->              
                ...
                <?php
                    if ($result->num_rows > 0) {
                        ...
                        echo "<td>" . $row['Nazwisko i Imie'] . "</td>";
                        echo "<td>" . $row['Data'] . "</td>";
                        echo "<td>" . $row['Projekt'] . "</td>";
                        echo "<td>" . $row['Godziny wypracowane'] . "</td>";
                        $sumagodzin = $sumagodzin + $row['Godziny wypracowane'];
                        echo "</tr>";
                        }
                    } 
                        else {
                ...
                <?php
                echo "Łączna ilość godzin przepracowana przez pracownika to: " . $sumagodzin;
                ?>
