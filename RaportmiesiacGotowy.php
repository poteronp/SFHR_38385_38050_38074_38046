...
$getMiesiac = $_GET['RaportMiesiac'];
$sql = "SELECT * FROM `planner` WHERE MONTH(`Data`) = '$getMiesiac'";
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Raport Dnia" />
        <meta name="author" content="Zespół I" />
        <title>Raport Dnia</title>
...
<!-- Przycisk rozwijany 
Raport Dnia -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Raport Dnia</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Miejsce na treść właściwą-->              
                ...
                <?php
                echo "Łączna ilość godzin przepracowana przez pracowników w tym miesiącu to: " . $sumagodzin;
                ?>
