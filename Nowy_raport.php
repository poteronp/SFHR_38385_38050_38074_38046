...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Utwórz nowy raport</h1>
...
<!-- Miejsce na treść właściwą-->              
                <div>
<center>
<p>W celu utworzenia raportu dla konkretnego pracownika naciśnij guzik</p><a href="Raportpracownik.php"><button type="button" class="btn btn-primary btn-square-md">Pracownik</button></a>

<p>W celu utworzenia raportu dla konkretnego projektu naciśnij guzik</p><a href="Raportprojekt.php"><button type="button" class="btn btn-primary btn-square-md">Projekt</button></a>
                    
<p>W celu utworzenia raportu dla konkretnego dnia naciśnij guzik</p><a href="Raportdzien.php"><button type="button" class="btn btn-primary btn-square-md">Dzień</button></a>
                    
<p>W celu utworzenia raportu podsumowującego miesiąc naciśnij guzik</p><a href="Raportmiesiac.php"><button type="button" class="btn btn-primary btn-square-md">Podsumowanie</button></a>
</center>
                </div>
