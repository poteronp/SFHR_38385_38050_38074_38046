...
$sql = "SELECT * FROM projekty_lista";
$result = $conn->query($sql);


if(isset($_POST['Generate'])){
    $RaportProjekt = $_POST['RaportProjekt'];
    if($RaportProjekt) {
        header("location: RaportprojektGotowy.php?RaportProjekt=$RaportProjekt");
    }    
} 
?>
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Stwórz Raport Projektu" />
        <meta name="author" content="Zespół I" />
        <title>Stwórz Raport Projektu</title>
...
<!-- Przycisk rozwijany 
Stwórz Raport Projektu -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Stwórz Raport Projektu</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Stwórz Raport Projektu</h1>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <select class="form-control" id="inputPracownik" name="RaportProjekt" type="text">
                                                <?php
