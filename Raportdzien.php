...
if(isset($_POST['Generate'])){
    $RaportDzien = $_POST['RaportDzien'];
    if($RaportDzien) {
        header("location: RaportdzienGotowy.php?RaportDzien=$RaportDzien");
    }    
} 
?>
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Stwórz Raport Dnia" />
        <meta name="author" content="Zespół I" />
        <title>Stwórz Raport Dnia</title>
...
<!-- Przycisk rozwijany 
Stwórz Raport Dnia -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Stwórz Raport Dnia</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Stwórz Raport Dnia</h1>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputDzien" name="RaportDzien" type="date"/>   
