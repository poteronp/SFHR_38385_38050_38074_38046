...
$getProjekt = $_GET['RaportProjekt'];
$sql = "SELECT * FROM Planner WHERE `Projekt` = '$getProjekt'";
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Raport Projektu" />
...
<!-- Przycisk rozwijany 
Raport Projektu -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Raport Projektu</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Raport Projektu</h1>
...
<!-- Miejsce na treść właściwą-->              
                ...
                <?php
                echo "Łączna ilość godzin przepracowana przez pracowników na rzecz tego projektu to: " . $sumagodzin;
                ?>
