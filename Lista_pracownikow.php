...
$sql = "SELECT id_user, full_name, position, type, status, email FROM users";
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lista Pracowników</h1>
...
<!-- Miejsce na treść właściwą-->
                ...
                <div id="layoutSidenav_content" class="card-body container-fluid px-4 card mb-4">
...
if ($result->num_rows > 0) {
    ...
    echo "<td><a href='Edit.php?edit=$id' ><i style='font-size:20px' color='black' class='fas'>&#xf044;</i></a></td>";
    echo "</tr>";
    }
} 
    else {
