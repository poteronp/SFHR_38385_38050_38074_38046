...
$sql = "SELECT id_user, full_name, position, type, status, email, end_date FROM users WHERE `type` = 'Pracownik'";
$result = $conn->query($sql);


if(isset($_POST['Generate'])){
    $RaportPracownik = $_POST['RaportPracownik'];
    if($RaportPracownik) {
        header("location: RaportPracownikGotowy.php?RaportPracownik=$RaportPracownik");
    }    
} 
...
<!-- W znaczniku Head znajdują się wszelkie informacje na temat strony. Autor, opis, tytuł, powiązania do CSS-->
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Stwórz Raport Pracownika" />
        <meta name="author" content="Zespół I" />
        <title>Stwórz Raport Pracownika</title>
...
<!-- Przycisk rozwijany 
Stwórz Raport Pracownika -> Pracownik mam możliwość wypełnienia swojego TimeSheetu
-->
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link" href="zaplanuj_czas_pracy.php">Stwórz Raport Pracownika</a>
                                </nav>
                            </div>
<!-- END Planner-->
...
<!-- Nagłowek do powitania-->
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Stwórz Raport Pracownika</h1>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <select class="form-control" id="inputPracownik" name="RaportPracownik" type="text">
                                                <?php
                                                ...
                                                <label for="inputLastName">Nazwisko i Imię</label>
                                            </div>
                                            <div class="mt-4 mb-0">
